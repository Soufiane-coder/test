import './DisplayModeSwitcher.scss';
...
const DisplayModeSwitcher = ({ displayMode, setDisplayModeTo }) => {
    ...
    return (
        <label className="switch">
            ...
            <input type="checkbox" className="input" checked={displayMode === 'dark'} onChange={handleChange} />
...
const mapDispatchToProps = (dispatch) => ({
    setDisplayModeTo: (displayMode) => dispatch(setDisplayModeTo(displayMode)),
})

export default connect(mapStateToProps, mapDispatchToProps)(DisplayModeSwitcher);